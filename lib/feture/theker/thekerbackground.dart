...
class Theker_Background extends StatefulWidget {
  Theker_Background({super.key});

  @override
  State<Theker_Background> createState() => _Theker_BackgroundState();
}

var Scaffold_theker_key = GlobalKey<ScaffoldState>();
...
class _Theker_BackgroundState extends State<Theker_Background> {
  @override
